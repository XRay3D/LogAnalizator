...
Adafruit_SPFD54124B::Adafruit_SPFD54124B(int8_t SID, int8_t SCLK, int8_t RST, int8_t CS)
    : Adafruit_GFX(SPFD54124B_LCDWIDTH, SPFD54124B_LCDHEIGHT)
{
    sid = SID;
    sclk = SCLK;
    rst = RST;
...
Adafruit_SPFD54124B::Adafruit_SPFD54124B(int8_t RST, int8_t CS)
    : Adafruit_GFX(SPFD54124B_LCDWIDTH, SPFD54124B_LCDHEIGHT)
{
    sid = -1;
    sclk = -1;
...
#define DELAY 0x80
PROGMEM static const unsigned char initCmd[] = {
